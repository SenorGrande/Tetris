...
This is a sample template for highscore-service - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name highscore-service --tail
```
...
```bash
aws cloudformation delete-stack --stack-name highscore-service
```
